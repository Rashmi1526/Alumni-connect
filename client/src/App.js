    ...
    <div>
      <Router>
        <Switch>
          ...
          <Route exact path="/alumniDetails" component={AlumniDetails}/>
          ...
          <Route exact path="/admin/addAlumni" component={AdminAddAlumni} />
          ...
          <Route exact path="/alumni/updatePassword" component={AlumniUpdatePassword}/>
