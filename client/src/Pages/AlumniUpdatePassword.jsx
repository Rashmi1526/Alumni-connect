...
import { alumniUpdatePassword } from '../redux/action/alumniAction'




const AlumniUpdatePassword = () => {
    ...
    const formHandler = (e) => {
        e.preventDefault()
        dispatch(alumniUpdatePassword({ registrationNumber: store.alumni.alumni.alumni.registrationNumber, oldPassword, newPassword, confirmNewPassword }))
    }
    return (
        <div>
...
export default AlumniUpdatePassword
